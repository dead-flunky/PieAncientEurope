...
from CvPythonExtensions import (CyGlobalContext, PlayerTypes, CyEngine,
                                CyGame, CyMap, DomainTypes, PlotStyles,
                                PlotLandscapeLayers, InvisibleTypes)
...
# a given unit.
# Main function to be used from outside are :
    ...
    def checkUnit(self, pPlot):
        ...
        for i in xrange(iNumUnits):
            ...
            if (iInvisibleType != InvisibleTypes.NO_INVISIBLE):
                for j in xrange(self.pUnit.getNumSeeInvisibleTypes()):
