...
class OptionsHandler(Handler):
    ...
    def __init__(self):
        Handler.__init__(self, self.TAG, "id file", SectionHandler.TAG)
...
class SectionHandler(Handler):
    ...
    def __init__(self):
        Handler.__init__(self, self.TAG, "id name", (OptionHandler.TAG,))
...
class BaseOptionHandler(Handler):

    def __init__(self, tag, validAttrs="", validChildren="", elementClass=BugConfig.Element):
        Handler.__init__(self, tag, validAttrs, validChildren, elementClass)
        self.addAttribute("id", True)
...
class ListChoiceHandler(Handler):

    TAG = "choice"

    def __init__(self):
        Handler.__init__(self, self.TAG, "id get set", ())
        self.addAttribute("id", True)
        self.addAttribute("get")
        self.addAttribute("set")
...
class ChangeHandler(Handler):
    ...
    def __init__(self):
        Handler.__init__(self, self.TAG, "dirtyBit module function")
...
class AccessorHandler(Handler):

    TAG = "accessor"

    def __init__(self):
        Handler.__init__(self, self.TAG, "id args get set", ())
        self.addAttribute("id", True)
