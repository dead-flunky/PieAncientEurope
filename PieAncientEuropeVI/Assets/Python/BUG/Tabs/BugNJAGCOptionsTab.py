...
class BugNJAGCOptionsTab(BugOptionsTab.BugOptionsTab):
	...
	def create(self, screen):
        ...
        # Flunky added colors for PAE tech chooser
		# self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_ANCIENT", True)
		# self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_BRONZE", True)
		...
		# self.addColorDropdown(screen, centerPanelL, centerPanelR, "NJAGC__Color_ERA_LATE_ANTIQUITY", True)
