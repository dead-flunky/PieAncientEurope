...
class BugMapOptionsTab(BugOptionsTab.BugOptionsTab):
    ...
    def create(self, screen):
        ...
        self.addLabel(screen, column, "StrategyOverlay", "Strategy Layer:")
        self.addCheckbox(screen, column, "StrategyOverlay__Enabled")
        self.addCheckbox(screen, column, "StrategyOverlay__ShowDotMap")
        self.addCheckbox(screen, column, "StrategyOverlay__DotMapDrawDots")
        leftL, leftR = self.addTwoColumnLayout(screen, column, "DotMapBrightness")
