...
class BugCityScreenOptionsTab(BugOptionsTab.BugOptionsTab):
    ...
    def create(self, screen):
        ...
        # self.createBuildingActualEffectsPanel(screen, right) # was left
        #self.addSpacer(screen, left, "CityScreen3")
        # self.addSpacer(screen, right, "CityScreen4") # was left
    ...
    def createHurryDetailPanel(self, screen, panel):
        ...
        self.addCheckbox(screen, panel, "CityScreen__WhipAssist")
        self.addCheckbox(screen, panel, "CityScreen__WhipAssistOverflowCountCurrentProduction")
