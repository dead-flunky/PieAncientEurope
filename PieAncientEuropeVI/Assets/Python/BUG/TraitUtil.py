...
from CvPythonExtensions import (CyGlobalContext, FontSymbols, CommerceTypes,
                                YieldTypes)
...
def init():
    ...
    addTrait("INDUSTRIOUS", gc.getYieldInfo(YieldTypes.YIELD_PRODUCTION).getChar(),
             "Art/Interface/Buttons/TechTree/Industrialism.dds")
