...
from CvPythonExtensions import (CyGlobalContext, CyArtFileMgr, CyTranslator,
                                ...
                                CyGame, InputTypes, InfoBarTypes, TableStyles)
import CvUtil
# import ScreenInput
...
class IconGrid_BUG:
    ...
    def getPrefferedWidth(self):
        ...
        for index in xrange(len(self.columns)):
...
#        BugUtil.debug("addStackedbar %i %i %s %s %i" % (iColumnIndex, fValue, sColor, sText, iFont))
    ...
    def refresh(self):
        ...
        for rowIndex in xrange(maxIndex):
...
#                        BugUtil.debug("Stacked Bar done")
            ...
            for offset in xrange(len(self.columns) - startIndex):
...
#                    BugUtil.debug("Stacked Bar done")
    ...
    def calculateLayout(self):
        ...
        numMultiListCols = 0
        for colIndex in xrange(len(self.columns)):
    ...
    def addGroups(self):
        ...
        for index in xrange(len(self.columnGroups)):
