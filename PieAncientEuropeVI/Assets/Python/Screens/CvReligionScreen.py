...
class CvReligionScreen:
    ...
    def __init__(self):
        ...
        self.W_SCREEN = 1024
        self.H_SCREEN = 768
        self.X_SCREEN = self.W_SCREEN / 2# 500
        self.Y_SCREEN = 396
        self.Z_SCREEN = -6.1
        ...
        self.X_EXIT = self.W_SCREEN - 30 # 994
        self.Y_EXIT = self.H_SCREEN - 40 # 726
        self.X_CANCEL = 552
        self.Y_CANCEL = 726
        ...
        self.X_RELIGION_START = 180 #154
        self.DX_RELIGION = 98 #116
        ...
        self.X_RELIGION_AREA = 45 #0
        self.Y_RELIGION_AREA = 84 #0
        self.W_RELIGION_AREA = 934# 1008 + self.BUTTON_SIZE
        self.H_RELIGION_AREA = 175 #180
        
        self.H_SCROLL_OFFSET = 20

        self.X_CITY1_AREA = 45
        self.X_CITY2_AREA = 522
        self.Y_CITY_AREA = 282 #250
        self.W_CITY_AREA = 457
        self.H_CITY_AREA = 395 #460
    ...
    def drawHelpInfo(self):
        ...
        for iRel in self.RELIGIONS:
            if gc.getGame().getReligionGameTurnFounded(iRel) >= 0:
                ...
                screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1) # PAE: self.X_RELIGION_AREA + xLoop,
                xLoop += self.DX_RELIGION
