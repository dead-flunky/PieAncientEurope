...
from CvPythonExtensions import (CyGlobalContext, CyArtFileMgr, CyTranslator,
                                FontTypes, NotifyCode, MinimapModeTypes,
                                WidgetTypes, PanelStyles, ReplayMessageTypes,
                                CyGameTextMgr, TableStyles, CyGame, PopupStates,
                                CyReplayInfo, CyGInterfaceScreen)
import CvUtil
# import ScreenInput
# import time
import re
...
class CvReplayScreen:
    ...
    def resetData(self):
        ...
        for iPlayer in xrange(self.replayInfo.getNumPlayers()):
