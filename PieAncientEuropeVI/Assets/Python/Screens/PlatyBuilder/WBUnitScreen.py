...
class WBUnitScreen:
    ...
    def placeDirection(self):
        ...
        screen.setText("UnitHoldText", "Background", "<font=3>" + sColor + sText + "</color></font>", CvUtil.FONT_CENTER_JUSTIFY, screen.getXResolution()/2, iY + 1, -0.1, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
    ...
    def changeHold(self, pUnit, eType = None):
        ...
        if eType and eType not in holdActivities or not eType and pGroup.getActivityType() in holdActivities:
