...
def getHelpHolyMountain1(argsList):
	...
	#k-mod uses
	iMinPoints = gc.getWorldInfo(map.getWorldSize()).getTargetNumCities() # K-Mod
...
def canTriggerHolyMountainRevealed(argsList):
	...
	#k-mod - keldath addition
    #if iNumPoints < gc.getWorldInfo(gc.getMap().getWorldSize()).getDefaultPlayers() / 2:
    if iNumPoints < gc.getWorldInfo(map.getWorldSize()).getTargetNumCities() / 2:
        return False
