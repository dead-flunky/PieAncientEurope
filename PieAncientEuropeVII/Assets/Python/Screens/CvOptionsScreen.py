...
from CvPythonExtensions import (CyGlobalContext, CyArtFileMgr, CyTranslator,
                                CyUserProfile, isAlarmOn, getAlarmMinLeft,
                                getAlarmHourLeft, GraphicOptionTypes,
                                CvGameText, CyGame, PlayerOptionTypes,
                                CyGTabCtrl)
...
#########################################################################################
    ...
    def refreshScreen (self):
        ...
        for iOptionLoop in xrange(PlayerOptionTypes.NUM_PLAYEROPTION_TYPES):
...
#           self.getTabControl().setValue("PlaybackVolumeSlider", UserProfile.getMaxPlaybackVolume() - UserProfile.getPlaybackVolume())
        ...
        # Speaker config
        iInitialSelection = 0
        for iSpeakerConfigLoop in xrange(16):
        ...
        aszDropdownElements = ()
        for iProfileLoop in xrange(UserProfile.getNumProfileFiles()):
    ...
    def drawGameOptionsTab(self):
        ...
        aszDropdownElements = ()
        for i in xrange(CvGameText().getNumLanguages()):
    ...
    def drawGraphicOptionsTab(self):
        ...
        aszDropdownElements = ()
        for iResLoop in xrange(UserProfile.getResolutionMaxModes()):
        ...
        aszDropdownElements = ()
        for iAALoop in xrange(UserProfile.getAntiAliasingMaxMultiSamples()+1):
            if (iAALoop == 0):
        ...
        aszDropdownElements = ()
        for iMainMenuLoop in xrange(gc.getNumMainMenus()):
    ...
    def drawAudioOptionsTab(self):
        ...
        aszDropdownElements = ()
        for iCaptureDevice in xrange(UserProfile.getNumCaptureDevices()):
...
#        iInitialVal = iMax - UserProfile.getCaptureVolume()
        ...
        aszDropdownElements = ()
        for iPlaybackDevice in xrange(UserProfile.getNumPlaybackDevices()):
...
#        iInitialVal = iMax - UserProfile.getPlaybackVolume()
        ...
        aszDropdownElements = ()
        iInitialSelection = 0
        for iSpeakerConfigLoop in xrange(15):
