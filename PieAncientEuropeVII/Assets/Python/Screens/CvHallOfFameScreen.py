...
from CvPythonExtensions import (CyGlobalContext, CyArtFileMgr, CyTranslator,
                                ...
                                ButtonStyles, TableStyles, CyHallOfFameInfo)
import BugUtil
import CvUtil
# import ScreenInput
...
class CvHallOfFameScreen:
    ...
    def interfaceScreen(self, bAllowReplay):
        ...
        #for i in xrange(gc.getNumClimateInfos()):
        ...
        #for i in xrange(gc.getNumSeaLevelInfos()):
...
#        screen.setTableColumnHeader(self.TABLE_ID, , "", 73)
        ...
        iNumGames = 0
        for i in xrange(self.hallOfFame.getNumGames()):
