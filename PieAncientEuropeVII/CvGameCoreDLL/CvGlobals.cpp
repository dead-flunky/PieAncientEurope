...
m_iUSE_CANNOT_DRIVE_OUT_RELIGION_CALLBACK(0),
...
void CvGlobals::cacheGlobals()
{
    ...
    /* Flunky PAE Inquisition */
	m_iUSE_CANNOT_DRIVE_OUT_RELIGION_CALLBACK = getDefineINT("USE_CANNOT_DRIVE_OUT_RELIGION_CALLBACK");
...
// Flunky PAE Inquisition 
int CvGlobals::getUSE_CANNOT_DRIVE_OUT_RELIGION_CALLBACK()
{
	return m_iUSE_CANNOT_DRIVE_OUT_RELIGION_CALLBACK;
}
